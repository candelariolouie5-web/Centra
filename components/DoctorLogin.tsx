    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-800 text-center">Doctor Login</h2>
          <p className="text-gray-500 mt-2 text-sm text-center">
            Access your doctor panel securely.
          </p>
        </div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full p-3 pl-10 pr-10 rounded-xl border border-gray-300 bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
            required
          />
          <button
            type="button"
