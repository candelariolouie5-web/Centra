...
export default function DoctorPatientsPage() {
  ...
  const [, setMedicalHistoryKey] = useState(0);
  ...
  const fetchPatients = async () => {
    try {
      ...
      if (!res.ok) {
        ...
        apiError =
          data?.error || `HTTP ${res.status}: ${data?.message || "Unknown error"}`;
              ...
              <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-sm text-cyan-50/90 md:text-base">
                    Search, review, and manage assigned patients with the same
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-500">
                    Total assigned patient records
                  </p>
                </div>
                        ...
                        <div className="mx-auto flex max-w-sm flex-col items-center">
                          ...
                          <p className="mt-1 text-sm text-slate-400">
                            {search
                              ...
                              : "Create appointments to manage patients."}
                          </p>
                        </div>
                      </td>
                    </tr>
