...
export default function PatientsPage() {
  ...
  const [allAppointments, setAllAppointments] = useState<any[]>([]); // 👈 NEW
  ...
  // 👇 NEW: Fetch appointments to get phone numbers
      ...
      <main className="p-6">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* 👇 UPDATED: Pass appointments to PatientDetailsModal */}
            <PatientDetailsModal
              ...
              tab={tab}
              setTab={setTab}
              appointments={allAppointments} // 👈 ADD THIS
